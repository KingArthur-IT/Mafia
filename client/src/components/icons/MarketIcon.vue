<template>
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width="42.605px" height="42.605px" viewBox="0 0 42.605 42.605" style="enable-background:new 0 0 42.605 42.605;"
        xml:space="preserve">
        <g>
            <path d="M42.605,16.958c0-1.082-1.08-1.956-2.41-1.956H22.48L13.738,3.816c0,0-0.468,0.367-1.047,0.818
                ...
                C42.605,18.914,42.605,18.04,42.605,16.958z" fill="#757b8b"/>
            <path d="M33.648,38.79c2.66,0,4.817-2.159,4.817-4.815l2.408-13.05H6.549c-2.66,0-4.817,2.157-4.817,4.817L4.14,38.79H33.648z
                ...
                c0-1.33,0.967-2.41,2.159-2.41h2.158v8.834c0,1.33-0.967,2.408-2.158,2.408H7.149V26.345z" fill="#757b8b"/>
        </g>
    </svg>
</template>
